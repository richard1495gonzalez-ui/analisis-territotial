...
class Model:
    ...
    def get_overall_counts(self):
        ...
        cursor.execute("SELECT COUNT(*) AS total FROM Region")
        counts['regiones'] = cursor.fetchone()['total']
        
        cursor.execute("SELECT COUNT(*) AS total FROM Departamento")
        counts['departamentos'] = cursor.fetchone()['total']
        
        cursor.execute("SELECT COUNT(*) AS total FROM Municipio")
        counts['municipios'] = cursor.fetchone()['total']
